...
class InstructorAttendanceController extends Controller
{
    public function store(Request $request){
        if($request->expectsJson()){
            ...
            $attendace = InstructorAttendance::where('TANGGAL_MENGAJAR',$request->TANGGAL_MENGAJAR)->where('ID_INSTRUKTUR',$request->ID_INSTRUKTUR)->first();
            ...
            if($attendace){
                ...
                if($request->TANGGAL_MENGAJAR > Carbon::now()){
                    ...
                    $instructor = Instructor::where('ID_INSTRUKTUR',$request->ID_INSTRUKTUR)->first();
                    if($instructor){
                ...
                $store_data = InstructorAttendance::create([
