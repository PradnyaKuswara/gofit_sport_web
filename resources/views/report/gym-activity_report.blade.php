...
@section('main')
    <div class=" card my-5 p-3 bg-body rounded shadow-lg w-100 mx-auto no-print">
        ...
        <form action="{{ url('dashboard/gym-activity-report-process') }}" method="get" enctype="multipart/form-data">
            @csrf
    ...
    @else
        ...
        <div class="card">
            <div class="pb-3 ps-3 pe-3 pt-3 d-flex justify-content-between">
                <h3 class="card-title">GYM ACTIVITY REPORT {{ Session::get('year') }}</h3>
